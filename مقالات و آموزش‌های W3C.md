...
- [شروع کار با بین‌المللی‌سازی](https://www.w3.org/International/i18n-drafts/getting-started/index.en.html)
- [معرفی مجموعه‌های کاراکتر و رمزگذاری‌ها](https://www.w3.org/International/getting-started/characters.en.html)
- [زبان در وب](https://www.w3.org/International/getting-started/language.en.html)
- [نکات سریع برای بین‌المللی‌سازی در وب](https://www.w3.org/International/quicktips/index.en.html)

## کاراکترها

- [مدیریت رمزگذاری کاراکترها در HTML و CSS (آموزش)](https://www.w3.org/International/tutorials/tutorial-char-enc/index.en.html)
- [رمزگذاری کاراکتر برای مبتدیان](https://www.w3.org/International/questions/qa-what-is-encoding.en.html)
- [مفاهیم اساسی رمزگذاری کاراکتر](https://www.w3.org/International/articles/definitions-characters/index.en.html)
- [انتخاب و استفاده از یک رمزگذاری کاراکتر](https://www.w3.org/International/questions/qa-choosing-encodings.en.html)
- [چه کسانی از یونیکد استفاده می‌کنند؟](https://www.w3.org/International/questions/qa-who-uses-unicode.en.html)
- [اعلام رمزگذاری کاراکتر در HTML](https://www.w3.org/International/questions/qa-html-encoding-declarations.en.html)
- [اعلام رمزگذاری کاراکتر در CSS](https://www.w3.org/International/questions/qa-css-charset.en.html)
- [نشانه ترتیب بایت (BOM) در HTML](https://www.w3.org/International/questions/qa-byte-order-mark.en.html)
- [نرمال‌سازی در HTML و CSS](https://www.w3.org/International/questions/qa-html-css-normalization.en.html)
- [کاراکترها یا نشانه‌گذاری؟](https://www.w3.org/International/questions/qa-chars-vs-markup.en.html)
- [تغییر یک صفحه HTML به یونیکد](https://www.w3.org/International/questions/qa-changing-encoding.en.html)
- [استفاده از فرارهای کاراکتر در نشانه‌گذاری و CSS](https://www.w3.org/International/questions/qa-escapes.en.html)
- [مجموعه کاراکتر سند](https://www.w3.org/International/questions/qa-doc-charset.en.html)
- [تنظیم پارامتر charset در HTTP](https://www.w3.org/International/articles/http-charset/index.en.html)
...
- [کار با زبان در HTML (آموزش)](https://www.w3.org/International/tutorials/tutorial-char-enc/index.en.html)
...
- [برچسب های زبان در HTML و XML](https://www.w3.org/International/articles/language-tags/index.en.html)
- [انتخاب برچسب زبان](https://www.w3.org/International/questions/qa-choosing-language-tags.en.html)
...
- [یک ظاهر طراحی شده با استفاده از ویژگی های زبان](https://www.w3.org/International/questions/qa-css-lang.en.html)

## نشانه‌گذاری و متن

- [کار با پیام های کامپوزیت](https://www.w3.org/International/articles/composite-messages/index.en.html)
- [استفاده مجدد از رشته ها در محتوای اسکریپتی](https://www.w3.org/International/articles/text-reuse/index.en.html)
- [یاقوت چیست؟](https://www.w3.org/International/questions/qa-ruby.en.html)
- [نشانه گذاری روبی](https://www.w3.org/International/articles/ruby/markup.en.html)
- [استفاده از تگ های b و i](https://www.w3.org/International/questions/qa-b-and-i-tags.en.html)
- [استفاده از خصیصه ترجمهی HTML](https://www.w3.org/International/questions/qa-translate-flag.en.html)
- [برچسب های غیر انگلیسی](https://www.w3.org/International/questions/qa-non-eng-tags.en.html)
- [نکات بین المللی برای پیوند دادن به سرفصل ها و ارقام](https://www.w3.org/International/questions/qa-reference-links.en.html)
...
- [موارد استفاده برای بیدی و فراداده زبان در وب](https://www.w3.org/International/articles/lang-bidi-use-cases/index.en.html)
...
- [یک ظاهر طراحی شده با استفاده از ویژگی های زبان](https://www.w3.org/International/questions/qa-css-lang.en.html)
- [رویکردهای توجیه کامل](https://www.w3.org/International/articles/typography/justification.en.html)
- [خط شکنی Line Breaking](https://www.w3.org/International/articles/typography/linebreak.en.html)
...
- [کدگذاری فرم چند زبانه](https://www.w3.org/International/questions/qa-forms-utf-8.en.html)
- [نام های شخصی در سراسر جهان](https://www.w3.org/International/questions/qa-personal-names.en.html)
- [مرتب سازی گزینه های انتخاب شده](https://www.w3.org/International/questions/qa-select-sorting.en.html)
...
- [تنظیم تنظیمات برگزیده زبان در مرورگر](https://www.w3.org/International/questions/qa-lang-priorities.en.html)
- [پذیرش زبان مورد استفاده برای تنظیم محلی](https://www.w3.org/International/questions/qa-accept-lang-locales.en.html)

## ادرس وب

- [مقدمه ای بر ادرس های وب چند زبانه](https://www.w3.org/International/articles/idn-and-iri/index.en.html)

## مسائل فرهنگی

- [قابلیت نمایش](https://www.w3.org/International/questions/qa-display-capabilities.en.html)
- [زمان و تاریخ: مفاهیم اساسی](https://www.w3.org/International/articles/definitions-time/index.en.html)
- [قالبهای تاریخ](https://www.w3.org/International/questions/qa-date-format.en.html)
- [نام های شخصی در سراسر جهان](https://www.w3.org/International/questions/qa-personal-names.en.html)

## دیگر

- [محلی سازی در مقابل بین المللی سازی](https://www.w3.org/International/questions/qa-i18n.en.html)
